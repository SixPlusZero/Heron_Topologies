...
public final class WordCountTopology {
    ...
    public static void main(String[] args) throws AlreadyAliveException, InvalidTopologyException {
        ...
        builder.setSpout("pressure", new PressureSpout(), parallelism);
        ...
        conf.setContainerDiskRequested(
                ExampleResources.getContainerDisk(6 * parallelism, parallelism));
        conf.setContainerRamRequested(
                ExampleResources.getContainerRam(6 * parallelism, parallelism));
