...
public final class TwoBolts {
    ...
    public static class PressureSpout extends BaseRichSpout {
        private static final long serialVersionUID = 4322775001819135036L;

        private static final int ARRAY_LENGTH = 128 * 1024;
        private static final int WORD_LENGTH = 20;
        private static final int BURST_TIME = 10*60*1000;
        private int RANDOM_WORD = 0;
        private final String[] words = new String[26];
        ...
        public void nextTuple() {
            ...
            if (count % 1000 == 0) {
                ...
                if (latency >= BURST_TIME) {
                    System.out.println("Bolt processed " + count + " tuples in " + latency + " ms");
                    Utils.sleep(1000*60);
                    RANDOM_WORD = rnd.nextInt(26);
                    startTime = System.currentTimeMillis();
                    count = 0;
            ...
            collector.emit(new Values(words[RANDOM_WORD]));
            count++;
        }
    }
    ...
    public static void main(String[] args) throws AlreadyAliveException, InvalidTopologyException {
        ...
        builder.setBolt("exclaim", new CountABolt(true), 2)
                .shuffleGrouping("word");
                //.shuffleGrouping("pressure");
        builder.setBolt("exclaim2", new ExclamationBolt(true), 1)
                .shuffleGrouping("exclaim");
        builder.setBolt("exclaim3", new ExclamationBolt(false), 1)
        ...
        //        ExampleResources.getComponentRam());
        //conf.setComponentRam("pressure",
        //        ExampleResources.getComponentRam());
        conf.setComponentRam("exclaim",
                ExampleResources.getComponentRam());
        conf.setComponentRam("exclaim2",
                ExampleResources.getComponentRam());
        conf.setComponentRam("exclaim3",
                ExampleResources.getComponentRam());
        ...
        conf.setContainerCpuRequested(7);
